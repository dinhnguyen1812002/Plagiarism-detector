...
public final class CLI {
    ...
    private static final String CREDITS = "IT Hutech";

    private static final String[] DESCRIPTIONS = {"Hệ thống Kiểm tra đạo mã nguồn, Khoa Công Nghệ thông tin hutech" };

    private static final String PROGRAM_NAME = "Hệ thống kiểm tra đạo mã nguồn ";
    ...
    public static void main(String[] args) {
        try {
            logger.debug("version {}", JPlag.JPLAG_VERSION);
            CLI cli = new CLI();
